...
def get_current_driver(
    ...
    """Resolves the Driver row linked to the logged-in user's account.

    Requires an admin to have called POST /drivers/{driver_id}/link-user first —
    until then, a user has no driver profile and this raises 403.
    """
